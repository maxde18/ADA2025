...
if __name__ == '__main__':
    ...
    create_subscription("de2024-435320", "diabetes_res", "diabetes_res_sub")
    pull_message(project="de2024-435320", subscription="diabetes_res_sub")  # replace your project id
